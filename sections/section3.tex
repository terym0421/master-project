...
\begin{proof}
  ...
  $P$のstripeを構成するパーツを左上から順に$X_1,\cdots,X_m$とおき，$X_1$から順に図\ref{parts deformation}にあるようにパーツの変形を施していく．ただし$X_i$が$A,A',C'$のいずれかであった場合，$X_{i+1}$以降は何もせず変形を終了する．

  \input{./sections/figures/figure10.tex}

  $\varphi(P') = T'=\text{Eqjdt}_x(T)$となることを示す．
