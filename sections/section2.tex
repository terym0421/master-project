...
また，定理\ref{restriction to fixed point}より，$S_\lambda|_{\complex^\lambda}$は$\complex^\lambda$における$\Omega_\lambda\subset\text{Gr}_k(\complex^n)$の法束のウェイトの積に等しい．(\ref{row echelon form})と(\ref{chart of grassmannian})より，
